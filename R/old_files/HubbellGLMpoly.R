...
#' @export
#'
HubbellGLMpoly <- function(formula,
                           family = hubbell.poly,
                           data,
                           weights,
                           subset,
  ...
  )), class = c(fit$class, c("HubbellGLMpoly", "lm")))
}


#' @export
family.HubbellGLMpoly <- function(object, ...) {
  object$family
}

#' @export
logLik.HubbellGLMpoly <- function(object, ...) {
  if (!missing(...)) {
